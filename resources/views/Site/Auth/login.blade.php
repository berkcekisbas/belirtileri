...
<head>
    ...
    <link href="{{ URL::asset('Admin/assets/global/plugins/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ URL::asset('Admin/assets/admin/pages/css/login-soft.css') }}" rel="stylesheet" type="text/css"/>
...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form" action="{{ URL::asset('site/auth/login') }}" method="post">
        {!! csrf_field() !!}
