...
@section('content')
    ...
    <script src="{{ URL::asset('admintools/assets/plugins/flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ URL::asset('admintools/assets/plugins/flot/jquery.flot.resize.min.js') }}"></script>
    ...
    <script src="{{ URL::asset('admintools/assets/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.j') }}s"></script>
    <script src="{{ URL::asset('admintools/assets/plugins/fullcalendar/fullcalendar/fullcalendar.js') }}"></script>
    <script src="{{ URL::asset('admintools/assets/js/index.js') }}"></script>
